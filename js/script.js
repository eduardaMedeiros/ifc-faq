const dados = [
    ...
    { titulo: "Atualização de Status de Cliente", id: "ST003", link: "status-cliente.html" },
    { titulo: "Habilitar Status PEN", id: "ST004", link: "status-cliente.html" },
    { titulo: "Limite dentro das requisições de status de cliente", id: "ST005", link: "status-cliente.html" },
    { titulo: "Como impossibilitar um cliente de efetuar compras no site?", id: "ST006", link: "status-cliente.html" },
    { titulo: "Como fazer com que os clientes voltem a comprar na plataforma após envio de status RPV?", id: "ST007", link: "status-cliente.html" },
    { titulo: "Os clientes atualmente logo que se cadastram tem o status PEN mas gostaria de possibilitar a compra para os mesmos após análise interna da empresa. Como proceder?", id: "ST008", link: "status-cliente.html" },
    { titulo: "Quando o cliente possui status PEN quais são os métodos de pagamento disponíveis para compra?", id: "ST009", link: "status-cliente.html" },
    { titulo: "O cliente consegue efetuar pedidos com a condição de pagamento boleto faturado tendo apenas status APV?", id: "ST010", link: "status-cliente.html" },
    { titulo: "Quais são os critérios que devo utilizar para determinar o status RPV para um cliente?", id: "ST011", link: "status-cliente.html" },
    { titulo: "Como um cliente pode verificar seu status atual na plataforma?", id: "ST012", link: "status-cliente.html" },
    { titulo: "Quais são as opções disponíveis para um cliente com o status RPV resolver sua situação e voltar a fazer compras na plataforma?", id: "ST013", link: "status-cliente.html" },
    { titulo: "Quais são as políticas de devolução e reembolso para clientes com diferentes status?", id: "ST014", link: "status-cliente.html" },
    //requisicoes
    ...
    { titulo: "Quantidade de requisições permitidas por hora na plataforma", id: "RE003", link: "requisicoes.html" },
...
function displayItems(filteredItems) {
    const itemsContainer = document.querySelector(".search-result");
    ...
    if (filteredItems.length > 0) {
        filteredItems.forEach(item => {
            ...
            itemElement.innerHTML += '<a onclick="pageResult(\'' + item.link + '\',\'' + item.id + '\')">'
                + item.titulo + '</a>';

            itemsContainer.appendChild(itemElement);
        });
    } else {
        itemsContainer.innerHTML = "<li><a>Nenhum item encontrado</a></li>";
    }
}
